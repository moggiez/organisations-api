terraform {
  ...
  backend "s3" {
    ...
    key            = "organisations-api-terraform.state"
    region         = "eu-west-1"
    dynamodb_table = "moggies.io-organisations-api-terraform_state"
  }
}
...
resource "aws_api_gateway_rest_api" "_" {
  ...
  description = "organisations-api API"
}


resource "aws_api_gateway_authorizer" "_" {
  name          = "organisations-api-UserAuthorizer"
